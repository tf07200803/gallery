...
function mobile_device_detect($iphone=true,$ipad=true,$android=true,$opera=false,$blackberry=true,$palm=true,$windows=true,$mobileredirect=false,$desktopredirect=false){
