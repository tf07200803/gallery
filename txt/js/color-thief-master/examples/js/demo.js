...
$(document).ready(function () {
  ...
  $('.run-functions-button').on('click', function(event) {
    var $this = $(this);
    $this.text('...');
    var $imageSection     = $this.closest('.image-section');//不重要
    var $colorThiefOutput = $imageSection.find('.color-thief-output');//輸出DIV
    var $targetimage      = $imageSection.find('.target-image');//來源圖片
